...
type GenesisState struct {
	...
	// asset_targets are the active asset vote targets (spec §21.6 stage 2).
	AssetTargets AssetList `protobuf:"bytes,8,rep,name=asset_targets,json=assetTargets,proto3,castrepeated=AssetList" json:"asset_targets"`
	// asset_prices are the current USD prices (and depth) of the assets.
	AssetPrices ExchangeRateTuples `protobuf:"bytes,9,rep,name=asset_prices,json=assetPrices,proto3,castrepeated=ExchangeRateTuples" json:"asset_prices"`
}
...
func (m *GenesisState) GetAssetTargets() AssetList {
	if m != nil {
...
func (m *GenesisState) GetAssetPrices() ExchangeRateTuples {
	if m != nil {
...
var fileDescriptor_7ff46fd82c752f1f = []byte{
	...
	,
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.AssetPrices = append(m.AssetPrices, ExchangeRateTuple{})
