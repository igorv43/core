...
import (
	...
	"github.com/classic-terra/core/v4/x/liquidstake/client/cli"
...
// GetTxCmd returns the hand-written transaction commands (AutoCLI cannot
// parse Coin positional arguments of gogoproto messages in this SDK line).
...
// EndBlock processes the epoch at its boundary (spec §24.4).
