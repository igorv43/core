...
func (AppModule) AutoCLIOptions() *autocliv1.ModuleOptions {
	return &autocliv1.ModuleOptions{
		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				{RpcMethod: "SubmitIntent", Skip: true}, {RpcMethod: "CancelIntent", Skip: true},
				{RpcMethod: "RegisterSolver", Skip: true}, {RpcMethod: "UnbondSolver", Skip: true},
				{RpcMethod: "DepositSolverEscrow", Skip: true}, {RpcMethod: "WithdrawSolverEscrow", Skip: true},
				{RpcMethod: "CommitBid", Skip: true}, {RpcMethod: "RevealBid", Skip: true},
				{RpcMethod: "RegisterFrontend", Skip: true}, {RpcMethod: "ApproveFrontend", Skip: true}, {RpcMethod: "RevokeFrontend", Skip: true},
				{RpcMethod: "CreateMarket", Skip: true}, {RpcMethod: "SetMarketEnabled", Skip: true}, {RpcMethod: "UpdateParams", Skip: true},
			},
		},
	}
}
