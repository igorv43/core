...
func (AppModule) AutoCLIOptions() *autocliv1.ModuleOptions {
	return &autocliv1.ModuleOptions{
		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				{RpcMethod: "BondOperator", Skip: true},
				{RpcMethod: "UnbondOperator", Skip: true},
				{RpcMethod: "ClaimBond", Skip: true},
				{RpcMethod: "SubmitEvidence", Skip: true},
				{RpcMethod: "DistributeRewards", Skip: true},
